<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"D:\PHPTutorial\WWW\test1\cltphp/app/user\view\set\index.html";i:1515137982;s:67:"D:\PHPTutorial\WWW\test1\cltphp/app/user\view\common\loginHead.html";i:1515137982;s:64:"D:\PHPTutorial\WWW\test1\cltphp/app/user\view\common\footer.html";i:1515137982;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="layui-form layui-form-pane layui-tab-item layui-show">
                    <form method="post">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="L_username" name="username" lay-verify="required" value="<?php echo $userInfo['username']; ?>" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <textarea placeholder="随便写些什么刷下存在感" id="sign"  name="sign" class="layui-textarea" style="height: 80px;"><?php echo $userInfo['sign']; ?></textarea>
                            </div>
                        </div>
                        <div class="layui-form-item">
