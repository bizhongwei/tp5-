<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\PHPTutorial\WWW\test1\cltphp/app/home\view\article_show.html";i:1515137982;s:62:"D:\PHPTutorial\WWW\test1\cltphp/app/home\view\common_head.html";i:1515137982;s:64:"D:\PHPTutorial\WWW\test1\cltphp/app/home\view\common_footer.html";i:1515137982;}*/ ?>
<!DOCTYPE html>
...
<section id="content-wrapper">
    <div class="row">
        <div class="eight columns">
            <!-- blog post 1 -->
            <div class="blog-post">
                <img src="<?php echo $info['title_thumb']; ?>" alt="blog-img" />
                <div class="post-info">
                    ...
                    <ul>
                        ...
                        <li class="tag-icon"><a href="<?php echo $info['formlink']; ?>" target="_blank"><?php echo $info['copyfrom']; ?></a></li>
                        <!--<li class="comment-icon"><a href="#">8 Comments</a></li>-->
                    </ul>
                </div>
                <div class="post-content">
                    <h4 style="<?php echo $info['title_color']; ?>;<?php echo $info['title_weight']; ?>"><?php echo $info['title']; ?></h4>
        ...
        <div class="four columns">
            ...
            ->where("posid = 2 and catid=".input(catId)." ")
            ->field("a.*,c.catdir")
            ->limit(10)
            ->order("listorder asc,createtime desc")
            ->select();foreach ($result as $k=>$vo):?>
                    <li><a href="<?php echo url('home/'.$vo['catdir'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" style="<?php echo style($vo['title_style']); ?>" title="<?php echo $vo['title']; ?>"><?php echo $vo['title']; ?></a></li>
                    <?php endforeach ?>
                </ul>
            </aside>
        </div>
